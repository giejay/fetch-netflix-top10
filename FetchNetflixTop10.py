...
trakt_list_url = 'https://api.trakt.tv/users/me/lists/Netflix-Top10-Movies/items/'
...
trakt_list_add_url = 'https://api.trakt.tv/users/me/lists/Netflix-Top10-Movies/items'
...
def get_flixpatrol_top10():
    res = requests.get("https://flixpatrol.com/top10/netflix/netherlands/",headers = headers)
...
def process_list(type):
    ...
    if response.status_code == 200:
        ...
        Desc = 'Netflix Top 10 ' + str(type) + ' in the Netherlands, updated daily'
        ...
        if trace:
            print('trakt response code for creation of list ',response.status_code)
